 ...
 * would sit under the translucent well and blot out the terrain behind it.
 */
...
export function createStick(input: StickInput): void {
  ...
  base.style.setProperty("--ww-stick-clip", steppedCircle(CELLS));
  base.style.setProperty("--ww-stick-ring", steppedRing(CELLS, RIM));
